...
export const routes: Routes = [
  ...
  { path: 'on-the-rise', component: StatsOnTheRiseComponent, data: { bg: "assets/img/courthouse.jpg", previous: '/upcoming', next: '/dancers' } },
  { path: 'dancers', component: DancersPageComponent, data: { bg: "assets/img/swingdanceuk.jpg", previous: '/on-the-rise', next: '/events' } },
